---
comments: true
description: Learn how to train NEU_DET_data on single or multiple GPUs using YOLOv5. Includes setup, training modes and result profiling for efficient leveraging of multiple GPUs.

---
comments: true
description: Learn how to train your data on custom NEU_DET_data using YOLOv5. Simple and updated guide on collection and organization of images, labelling, model training and deployment.
...
path: ../NEU_DET_data/coco128  # dataset root dir
...
```bash
../NEU_DET_data/coco128/images/im0.jpg  # image
../NEU_DET_data/coco128/labels/im0.txt  # label
```

    ...
    Example:
        ...
        data = dict(
            train=dict(
                ...
                grounding_data=[
                    dict(
                        img_path="../NEU_DET_data/flickr30k/images",
                        json_file="../NEU_DET_data/flickr30k/final_flickr_separateGT_train.json",
                    ),
                    dict(
                        img_path="../NEU_DET_data/GQA/images",
                        json_file="../NEU_DET_data/GQA/final_mixed_train_no_coco.json",
                    ),
                ],
            ),
